...
const CliHelpReportSchema = z.object({
  answer: z
    .string()
    .describe('The detailed answer to the user question about isQCoder.'),
  sources: z
    .array(z.string())
...
/**
 * An agent specialized in answering questions about isQCoder itself,
...
export const CliHelpAgent = (
  ...
  description:
    'Specialized in answering questions about how users use you, (isQCoder): features, documentation, and current runtime configuration.',
  inputConfig: {
    inputSchema: {
      type: 'object',
      properties: {
        question: {
          type: 'string',
          description: 'The specific question about isQCoder.',
        },
      },
      required: ['question'],
    },
  ...
  promptConfig: {
    query:
      'Your task is to answer the following question about isQCoder:\n' +
      '<question>\n' +
      '${question}\n' +
      '</question>',
    systemPrompt:
      "You are **CLI Help Agent**, an expert on isQCoder. Your purpose is to provide accurate information about isQCoder's features, configuration, and current state.\n\n" +
      '### Runtime Context\n' +

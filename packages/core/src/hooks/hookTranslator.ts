...
/**
 * Decoupled LLM request format - stable across isQCoder versions
 */
...
/**
 * Decoupled LLM response format - stable across isQCoder versions
 */
...
/**
 * Decoupled tool configuration - stable across isQCoder versions
 */

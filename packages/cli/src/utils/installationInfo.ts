...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @isqcoder/isqcoder-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @isqcoder/isqcoder-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @isqcoder/isqcoder-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @isqcoder/isqcoder-cli@latest';
    return {

...
export const INFORMATIVE_TIPS = [
  ...
  'Show isQCoder status in the terminal window title (/settings)…',
  ...
  'Create a project-specific ISQCODER.md file with /init…',
  ...
  'Reload instructional context from ISQCODER.md files with /memory refresh…',
  'List the paths of the ISQCODER.md files in use with /memory list…',
